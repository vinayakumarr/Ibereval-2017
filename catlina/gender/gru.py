...
if __name__ == "__main__":
    ...
    test_df = pd.read_csv('data/testing_tweets_ca.txt', sep='\t',header=0)
    testclasslabels = pd.read_csv('data/testing_truth_ca.txt', header=0)
    ...
    model.save("logs2/lstm_model.hdf5")
